			...
			<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown active"><a
						...
						<form action="/navigation" method="post" class="dropdown-menu">
							<button type="submit" name="goto" class="btn dropdown-item"
								value="add-doctor">Add doctor</button>
							<button type="submit" name="goto" class="btn dropdown-item"
								value="view-doctors">View doctors</button>
						</form></li>
				</c:if>
				...
				<c:if test="${sessionScope.get('connectedRole') eq 'PATIENT'}">
					<li class="nav-item dropdown active"><a
						...
						<form action="/navigation" method="post" class="dropdown-menu">
							<button type="submit" name="goto" class="btn dropdown-item"
								value="book-appointment">Book new appointment</button>
							<button type="submit" name="goto" class="btn dropdown-item"
								value="my-appointments">My appointments</button>
						</form></li>
					...
					<li class="nav-item dropdown active"><a
						...
						<form action="/navigation" method="post" class="dropdown-menu">
							<button type="submit" name="goto" class="btn dropdown-item"
								value="patient-profile">View Profile</button>
						</form></li>
				</c:if>
				...
				<c:if test="${sessionScope.get('connectedRole') eq 'DOCTOR'}">
					<li class="nav-item dropdown active"><a
						...
						<form action="/navigation" method="post" class="dropdown-menu">
							<button type="submit" name="goto" class="btn dropdown-item"
								value="doctor-appointments">View Appointments</button>
						</form></li>
